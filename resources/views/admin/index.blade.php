            ...
            <div class="content-body">
                    ...
                    <div class="col-lg-8 col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div style="margin-top: 8px" class="card-body p-0 pb-0">
                                    <div class="chartist">
                                                ...
                                                <div class="media-body text-right mt-2">
                                                    <ul class="list-unstyled users-list">
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="برات هادیان" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle" src="{{ asset('') }}admin/assets/images/portrait/avatar-s-19.png" alt="Avatar">
                                                        </li>
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="کاترین نیکولس" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle" src="{{ asset('') }}admin/assets/images/portrait/avatar-s-18.png" alt="Avatar">
                                                        </li>
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="جوزف ویور" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle" src="{{ asset('') }}admin/assets/images/portrait/avatar-s-17.png" alt="Avatar">
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="media d-flex">
                                                ...
                                                <div class="media-body text-right mt-1">
                                                    ...
                                                    <h6 class="mt-1"><span class="text-muted white">تحلیل <a href="#" class="darken-2 white">سال گذشته.</a></span></h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row match-height">
                    <div class="col-md-12 col-lg-6 col-xl-4">
                        <h5 class="card-title text-bold-700 my-2">پیام های اخیر</h5>
                        <div class="card">
                            <div class="card-header">
                                            ...
                                            <div class="chat">
                                                <div class="chat-avatar">
                                                    <a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
                                                        <img src="{{ asset('') }}admin/assets/images/portrait/avatar-s-19.jpg" alt="avatar" />
                                                    </a>
                                                </div>
                                                <div class="chat-body">
                                            ...
                                            <div class="chat chat-left">
                                                <div class="chat-avatar">
                                                    <a class="avatar" data-toggle="tooltip" href="#" data-placement="left" title="" data-original-title="">
                                                        <img src="{{ asset('') }}admin/assets/images/portrait/avatar-s-15.jpg" alt="avatar" />
                                                    </a>
                                                </div>
                                                <div class="chat-body">
                                                    <div class="chat-content">
                                        ...
                                        <table class="table table-padded table-xl mb-0" id="recent-project-table">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <ul class="list-unstyled users-list m-0">
                                                        ...
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="کاترین نیکولس" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle" src="{{ asset('') }}admin/assets/images/portrait/avatar-s-14.png" alt="Avatar">
                                                        </li>
                                                    </ul>
                                                </td>
                                                <td class="text-truncate pb-0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <ul class="list-unstyled users-list m-0">
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="برات هادیان" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle" src="{{ asset('') }}admin/assets/images/portrait/avatar-s-11.png" alt="Avatar">
                                                        </li>
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="کاترین نیکولس" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle" src="{{ asset('') }}admin/assets/images/portrait/avatar-s-12.png" alt="Avatar">
                                                        </li>
                                                    </ul>
                                                </td>
                                                <td class="text-truncate pb-0">
